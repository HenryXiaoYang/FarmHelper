...
- Corrected the missing **How many are you selling?** stage: select a matching native quantity preset, or **Custom Amount**, then validate the sign's **Enter amount / to sell** prompt. A product-page right-click is not used to enter a quantity.
