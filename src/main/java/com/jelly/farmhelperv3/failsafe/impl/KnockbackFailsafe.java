...
public class KnockbackFailsafe extends Failsafe {
    ...
    public void onReceivedPacketDetection(ReceivePacketEvent event) {
        ...
        if (FlyPathFinderExecutor.getInstance().isRunning()) {
            AABB boundingBox = mc.player.getBoundingBox().inflate(2, 2.5, 2);
        ...
        LogUtils.sendWarning("[Failsafe] Knockback detected! MotionY: " + ((ClientboundSetEntityMotionPacket) event.packet).movement().y * 8000);
    ...
    public void duringFailsafeTrigger() {
        ...
        switch (knockbackCheckState) {
            ...
            case GO_BACK_START:
                ...
                if (mc.player.blockPosition().distSqr(positionBeforeReacting) < 500) {
