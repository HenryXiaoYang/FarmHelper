...
public class AutoRepellent implements IFeature {
    ...
    public void onTickExecution(TickEvent.ClientTickEvent event) {
        ...
        switch (state) {
            ...
            case SELECT_REPELLENT:
                ...
                mc.player.getInventory().setSelectedSlot(repellentSlot);
        ...
        switch (state) {
            case OPEN_SKYMART:
                if (guiName.equals("Desk")) {
                    ...
                    InventoryUtils.clickContainerSlot(skymartSlot.index, InventoryUtils.ClickType.LEFT, InventoryUtils.ClickMode.PICKUP);
                } else if (guiName.equals("SkyMart")) {
                    Slot pestsSlot = InventoryUtils.getSlotOfItemInContainer("Pests");
                    if (pestsSlot == null) {
                        break;
                    }
                    InventoryUtils.clickContainerSlot(pestsSlot.index, InventoryUtils.ClickType.LEFT, InventoryUtils.ClickMode.PICKUP);
            ...
            case CLICK_REPELLENT:
                ...
                InventoryUtils.clickContainerSlot(repellentSlot.index, InventoryUtils.ClickType.LEFT, InventoryUtils.ClickMode.PICKUP);
                delayClock.schedule(FarmHelperConfig.getRandomGUIMacroDelay());
            case CONFIRM_BUY:
                if (guiName.equals("Confirm")) {
                    ...
                    InventoryUtils.clickContainerSlot(confirmSlot.index, InventoryUtils.ClickType.LEFT, InventoryUtils.ClickMode.PICKUP);
                    delayClock.schedule(FarmHelperConfig.getRandomGUIMacroDelay());
                    break;
                }
                break;
    ...
    public void onChatReceived(ClientChatReceivedEvent event) {
        String message = ChatFormatting.stripFormatting(event.message.getString()); // just to be sure lol
